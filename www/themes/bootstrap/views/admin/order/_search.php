<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'company',array('class'=>'span5','maxlength'=>200, 'placeholder'=>'请输入'.$model->getAttributeLabel('company'))); ?>

	<?php echo $form->textFieldRow($model,'product',array('class'=>'span5', 'placeholder'=>'请输入'.$model->getAttributeLabel('product'))); ?>
