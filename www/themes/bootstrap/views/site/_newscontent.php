                ...
                <table width="200" border="0" cellpadding="0" cellspacing="1">
                    <tr>
                        <td height="25" bgcolor="#F2F2F2">
                            <div align="center" class="fn-fs-14"><a href="<?php echo $this->createUrl('site/companynews');?>">公司新闻</a></div>
                        </td>
                    </tr>
                </table>
                <table width="200" border="0" cellpadding="0" cellspacing="1">
                    <tr>
                        <td height="25" bgcolor="#F2F2F2">
                            <div align="center" class="fn-fs-14"><a href="<?php echo $this->createUrl('site/industrynews');?>">行业动态</a></div>
                        </td>
                    </tr>
                </table>
                <table width="200" border="0" cellpadding="0" cellspacing="1">
                    <tr>
                        <td height="25" bgcolor="#F2F2F2">
                            <div align="center" class="fn-fs-14"><a href="<?php echo $this->createUrl('site/medianews');?>">媒体报道</a></div>
                        </td>
                    </tr>
                </table>
                <br/></td>
