...
class TbPager extends CLinkPager
{
	...
	protected function createPageButton($label, $page, $class, $hidden, $selected)
	{
        ...
        // 下一页
        if ($label === '&rarr;')
            return CHtml::tag('li', array('class'=>$class), CHtml::link($label, $this->createPageUrl($page), array('title' => '下一页')));

        // 上一页
        if ($label === '&larr;')
            return CHtml::tag('li', array('class'=>$class), CHtml::link($label, $this->createPageUrl($page), array('title' => '上一页')));
