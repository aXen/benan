...
class Order extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, country, province, city, county, address, company, product, type, user_type, tel, message', 'required'),
			array('product', 'numerical', 'integerOnly'=>true),
			array('name, country, province, city, county, address, company, user_type_name', 'length', 'max'=>200),
			...
			array('id, name, country, province, city, county, address, company, product, type, type_name, user_type, user_type_name, ip, tel, email, message, status, creator, create_time, modifier, modify_time', 'safe', 'on'=>'search'),
		);
	}
