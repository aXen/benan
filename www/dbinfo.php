...
<body>
	<div
		style="margin: 0 auto; width: 880px; border: 1px #006600 solid; font-size: 12px; line-height: 20px;">
		<div
			style="width: 100%; height: 30px; font-size: 16px; font-weight: bold; text-align: center;">
			数据库结构<br /> <font style="font-size: 14px; font-weight: normal;"><?php echo date("Y-m-d h:i:s"); ?>
			</font>
		</div>
		<?php
